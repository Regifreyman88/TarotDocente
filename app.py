...
arcanos_ergodicos = [
    {"titulo": "ADICIÓN", "aplicacion_generica": "Añade una capa. Inserta un nuevo elemento que cambie por completo el significado de la historia original.", "imagen": "adicion.png"},
    {"titulo": "OMISIÓN", "aplicacion_generica": "Crea un vacío. Elimina el elemento más obvio o importante de la narrativa. ¿Qué nueva historia emerge del silencio y la ausencia?", "imagen": "omision.png"},
    {"titulo": "TRANSPOSICIÓN", "aplicacion_generica": "Altera la secuencia. Narra la historia desde el final hacia el principio.", "imagen": "transposicion.png"},
    {"titulo": "PERMUTACIÓN", "aplicacion_generica": "Invierte la función. Toma un objeto y dale el significado de otro. Intercambia la función de dos elementos.", "imagen": "permutacion.png"}
]

herramientas_del_creador = [
    {"titulo": "El pincel de la imaginación absoluta", "aplicacion_didactica": "Representa con arte visual (collage, dibujo, maqueta, prototipo, mapa creativo).", "traduccion_ia": "🎨 DALL·E, Midjourney, Leonardo AI.", "imagen": "pincel.png"},
    {"titulo": "Lente de recuerdos infinitos", "aplicacion_didactica": "Usa fotos, documentación, archivo visual o narrativas del pasado.", "traduccion_ia": "🖼️ RunwayML, Photoshop AI, GPT.", "imagen": "lente.png"},
    {"titulo": "Espejo de rostros vivientes", "aplicacion_didactica": "Crea personajes o roles desde la perspectiva del otro.", "traduccion_ia": "🧑‍🎤 D-ID, HeyGen, Character.AI.", "imagen": "espejo.png"},
    {"titulo": "La lira sonora", "aplicacion_didactica": "Traduce ideas a sonido: canción, podcast, atmósfera sonora.", "traduccion_ia": "🎵 Suno, Soundraw, ElevenLabs.", "imagen": "lira.png"},
    {"titulo": "Pergamino de visiones dinámicas", "aplicacion_didactica": "Expresa con videos, visual thinking, teatro breve, infografías.", "traduccion_ia": "📽️ Gamma, Synthesia, RunwayML.", "imagen": "pergamino.png"},
    {"titulo": "El libro de arena", "aplicacion_didactica": "Investiga a fondo desde múltiples fuentes, contrasta saberes.", "traduccion_ia": "🔍 ChatGPT, Perplexity AI, Scite.", "imagen": "libro_de_arena.png"},
    {"titulo": "La encarnación del fantasma", "aplicacion_didactica": "Da voz a lo ausente o silenciado; dramatiza lo invisible.", "traduccion_ia": "👻 D-ID, Murf.AI, GPT.", "imagen": "fantasma.png"}
]
...
with tab2:
    ...
    with col4:
        ...
        if st.button("Elegir un Verbo del Alquimista"):
            ...
            st.caption(carta['aplicacion_generica'])
...
with tab3:
    ...
    with st.expander("🧠 Educación Imaginativa"):
        st.markdown("Es una forma única de enseñanza que aprovecha la vida emocional e imaginativa de los estudiantes. El docente puede diseñar una actividad para estimular uno de los siguientes **tipos de imaginación:**\n\n- **Somática:** A través del cuerpo y los sentidos.\n- **Mítica:** A través de historias y metáforas.\n- **Romántica:** A través de la fascinación por lo extraordinario.\n- **Filosófica:** A través de la búsqueda de patrones y teorías.\n- **Irónica:** A través de la conciencia de las limitaciones del lenguaje.")
    with st.expander("💡 Ritual de Uso Sugerido"):
        st.markdown("1.  **La Invocación:** Saca una carta de 'La Llave del Asombro'.\n2.  **La Reacción:** El grupo dialoga sobre el desafío.\n3.  **La Elección:** Elige una 'Herramienta del Creador'.\n4.  **La Creación:** Produce un artefacto narrativo.\n5.  **La Reflexión:** Activa el ciclo SPARK para revisar el aprendizaje.")
